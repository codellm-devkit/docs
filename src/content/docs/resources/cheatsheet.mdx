...
One page, the daily moves: build one `analysis` object, then query it: the same interface for Java and Python. For the why and the walkthroughs, see [What is CLDK?](/what-is-cldk/), [Core concepts](/guides/concepts/), and the [Quickstart](/quickstart/).
...
<CardGrid>
  ...
  <LinkCard title="CLDK over MCP" description="Expose the same analysis layer as MCP tools." href="/resources/cldk-over-mcp/" />
</CardGrid>

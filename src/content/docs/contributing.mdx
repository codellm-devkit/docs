...
<Aside type="tip" title="There's a skill for adding language packs">
Adding a whole new language (a `codeanalyzer-<lang>` backend plus the SDK bindings) is scaffolded end to end by a CLDK skill that takes you to a validated level-1 analysis on a branch. See [codellm-devkit/developer-skillset](https://github.com/codellm-devkit/developer-skillset). The guides below are the manual walkthroughs behind what it automates.
</Aside>

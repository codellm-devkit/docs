...
- **A frontend** is an SDK that reads that JSON and gives you an `analysis` API. Two frontends exist today: the Python SDK, which is the reference implementation, and an alpha TypeScript SDK. A Rust frontend is planned. See [SDKs](/reference/sdks/).

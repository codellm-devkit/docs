...
You query every language through the same `analysis` API. A different backend answers for each one. CLDK supports Java, Python, and TypeScript. Java goes deepest, because it adds class-hierarchy analysis.

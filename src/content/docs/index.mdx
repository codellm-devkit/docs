...
description: "Typed call graphs, symbol tables, and reachability queries for code agents and tools."
tableOfContents: false
prev: false
next: false
hero:
  tagline: "CodeLLM-DevKit (<strong>CLDK</strong>) gives you typed call graphs, symbol tables, and reachability queries over a project. Your agents and tools can call them directly."
  actions:
    - text: Quickstart
      link: /quickstart/
      icon: rocket

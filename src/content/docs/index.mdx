...
next: false
hero:
  tagline: "CodeLLM-DevKit (<strong>CLDK</strong>) provides typed call graphs, symbol tables, and reachability queries over a project, callable from agents and tools."
  actions:
    - text: Quickstart
      link: /quickstart/
      icon: rocket

...
<CardGrid>
  <LinkCard title="Core concepts" description="What a static analysis is, why it approximates, and the four rungs CLDK builds." href="/guides/concepts/" />
  ...
  <LinkCard title="Python examples" description="Worked snippets against Flask, from symbol table to call graph." href="/examples/python/" />
</CardGrid>

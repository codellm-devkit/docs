...
`caniac` takes `-a 1|2|3`. The language backends take `-a 1..4`. The numbers do not line up, and `caniac` rejects level 4. Read this table, not the [dataflow levels](/guides/dataflow/#the-four-analysis-levels).
</Aside>
...
<CardGrid>
  <LinkCard title="IaC examples" href="/examples/iac/" description="Worked examples on the Quarkus Coffee Shop Helm chart." />

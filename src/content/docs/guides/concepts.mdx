...
- `AnalysisLevel.program_dependency_graph`: also builds dataflow inside each callable. <Badge text="2.0" variant="caution" />
- `AnalysisLevel.system_dependency_graph`: also builds dataflow across call boundaries. <Badge text="2.0" variant="caution" />

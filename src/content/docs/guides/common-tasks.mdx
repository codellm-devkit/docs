---
title: Common tasks
description: A cookbook of copy-paste CLDK snippets for the analysis questions you ask every day, each with the exact Python and Java call and the result it returns.
---

...
<CardGrid>
  ...
  <LinkCard title="codeanalyzer-ts" description="Beta. The TypeScript/TSX analyzer, emitting the canonical symbol-table and call-graph schema; entrypoint detection is still in progress." href="/backends/codeanalyzer-ts/" />

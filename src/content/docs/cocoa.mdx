...
<CardGrid>
  ...
  <LinkCard title="CLDK over MCP" description="Prefer a cross-process tool server to an in-process plugin? Expose CLDK over MCP instead." href="/resources/cldk-over-mcp/" />
</CardGrid>
